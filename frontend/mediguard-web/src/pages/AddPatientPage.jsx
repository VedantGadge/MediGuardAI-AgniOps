    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                // User confirmed it is a PUT request
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100">
            ...
            <Dialog open={showResultModal} onOpenChange={setShowResultModal}>
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-white">
                    ...
                    {predictionResults && (
                        <div className="absolute left-[-9999px] top-0 w-[800px] bg-white p-12 font-sans text-slate-900" id="prediction-report-content">
                            {/* Header */}
                            <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
                                <div>
                                    <h1 className="text-4xl font-bold text-slate-900 tracking-tight">Medical Prediction Report</h1>
                                    <p className="text-slate-500 mt-2 text-lg">Generated by MediGuard AI Intelligent Triage</p>
                                </div>
                                <div className="text-right">
                                    <div className="bg-slate-900 text-white px-4 py-1 rounded text-sm font-bold inline-block mb-2">CONFIDENTIAL</div>
                                    <p className="text-slate-500 text-sm">{new Date().toLocaleDateString()}</p>
                                </div>
                            </div>

                            {/* Patient Details Grid */}
                            <div className="bg-slate-50 rounded-lg p-6 border border-slate-200 mb-10">
                                <div className="grid grid-cols-2 gap-8">
                                    <div>
                                        <p className="text-xs uppercase tracking-wider text-slate-500 font-semibold mb-1">Patient Name</p>
                                        <p className="text-xl font-bold text-slate-900">{formData.patientName}</p>
                                    </div>
                                    <div>
                                        <p className="text-xs uppercase tracking-wider text-slate-500 font-semibold mb-1">Patient ID</p>
                                        <p className="text-xl font-mono font-bold text-slate-900">{formData.patientId}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Primary Prediction */}
                            <div className="mb-10">
                                <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Primary Diagnosis</h3>
                                <div className="bg-white border-l-4 border-slate-900 p-6 shadow-sm">
                                    <h2 className="text-5xl font-bold text-slate-900 mb-2">{predictionResults.prediction}</h2>
                                    <p className="text-slate-600 text-lg">AI Analysis Result</p>
                                </div>
                            </div>

                            {/* Top Contributing Factors */}
                            <div className="mb-10">
                                <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-6 border-b border-slate-200 pb-2">Key Risk Indicators</h3>
                                        ...
                                        return (
                                            <div key={index} className="relative">
                                                <div className="flex justify-between mb-2">
                                                    <span className="font-bold text-slate-800 text-lg">{feature.feature}</span>
                                                </div>
                            ...
                            {predictionResults.explanation && (
                                <div className="mb-10">
                                    <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Executive Summary</h3>
                                    <div className="text-slate-800 leading-relaxed text-lg text-justify">
                                        {predictionResults.explanation}
                                    </div>
                                </div>
                            )}
                            ...
                            {predictionResults.report && (
                                <div className="space-y-10">
                                    {predictionResults.report.clinical_analysis && (
                                        <div>
                                            <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Clinical Analysis</h3>
                                            <div className="text-slate-700 leading-relaxed text-base whitespace-pre-wrap text-justify">
                                                {predictionResults.report.clinical_analysis}
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {predictionResults.report.etiology_pathophysiology && (
                                        <div>
                                            <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Etiology & Pathophysiology</h3>
                                            <div className="text-slate-700 leading-relaxed text-base whitespace-pre-wrap text-justify">
                                                {predictionResults.report.etiology_pathophysiology}
                                            </div>
                                        </div>
                                    ...
                                    {predictionResults.report.recommendations && (
                                        <div>
                                            <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Clinical Recommendations</h3>
                                    ...
                                    {predictionResults.report.full_report && (
                                        <div>
                                            <h3 className="text-sm uppercase tracking-wider text-slate-500 font-bold mb-4 border-b border-slate-200 pb-2">Comprehensive Report</h3>
                                            <div className="text-slate-700 leading-relaxed text-base whitespace-pre-wrap text-justify">
                                                {predictionResults.report.full_report}
                                            </div>
                                        </div>
                            ...
                            {/* Footer */}
                            <div className="mt-16 pt-8 border-t-2 border-slate-800 flex justify-between items-end text-slate-400 text-sm">
                                <div>
                                    <p className="font-bold text-slate-900 mb-1">MediGuard AI</p>
                                    <p>Advanced Medical Diagnostics Support System</p>
                                </div>
                                <div className="text-right">
